...
search_journal() {
    ...
    read -p "Введите степень важности ("emerg" (0), "alert" (1),
           "crit" (2), "err" (3), "warning" (4), "notice" (5), "info" (6), "debug" (7)): " priority
    read -p "ВВедите строку для grep: " req
...
main_menu() {
    ...
    case $option in
        ...
        3 ) conf_service ;;
        4 ) search_journal ;;
        5 | q ) echo -e "Shutting down..." & exit 0 ;;
